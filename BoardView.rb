...
class BoardView
    ...
    def display_board(model)
        ...
        if rows == 3
            if columns == 3
                print "0 #{stonesArr[0]} - - #{stonesArr[1]} - - #{stonesArr[2]}\n"
                print "  | \\   |   / |\n"
                print "  |   \\ | /   |\n"
                print "1 #{stonesArr[3]} - - #{stonesArr[4]} - - #{stonesArr[5]}\n"
                print "  |   / | \\   |\n"
                print "  | /   |   \\ |\n"
                print "2 #{stonesArr[6]} - - #{stonesArr[7]} - - #{stonesArr[8]}\n"
                print "  0     1     2\n"
            else
            ...
            if columns == 5
                print "0 #{stonesArr[0]} - - #{stonesArr[1]} - - #{stonesArr[2]} - - #{stonesArr[3]} - - #{stonesArr[4]}\n"
                print "  | \\   |   / | \\   |   / |\n"
                print "  |   \\ | /   |   \\ | /   |\n"
                print "1 #{stonesArr[5]} - - #{stonesArr[6]} - - #{stonesArr[7]} - - #{stonesArr[8]} - - #{stonesArr[9]}\n"
                print "  |   / | \\   |   / | \\   |\n"
                print "  | /   |   \\ | /   |   \\ |\n"
                print "2 #{stonesArr[10]} - - #{stonesArr[11]} - - #{stonesArr[12]} - - #{stonesArr[13]} - - #{stonesArr[14]}\n"
                print "  | \\   |   / | \\   |   / |\n"
                print "  |   \\ | /   |   \\ | /   |\n"
                print "3 #{stonesArr[15]} - - #{stonesArr[16]} - - #{stonesArr[17]} - - #{stonesArr[18]} - - #{stonesArr[19]}\n"
                print "  |   / | \\   |   / | \\   |\n"
                print "  | /   |   \\ | /   |   \\ |\n"
                print "4 #{stonesArr[20]} - - #{stonesArr[21]} - - #{stonesArr[22]} - - #{stonesArr[23]} - - #{stonesArr[24]}\n"
                print "  0     1     2     3     4\n"
            elsif columns == 9
                print "0 #{stonesArr[0]} - - #{stonesArr[1]} - - #{stonesArr[2]} - - #{stonesArr[3]} - - #{stonesArr[4]} - - #{stonesArr[5]} - - #{stonesArr[6]} - - #{stonesArr[7]} - - #{stonesArr[8]}\n"
                print "  | \\   |   / | \\   |   / | \\   |   / | \\   |   / |\n"
                print "  |   \\ | /   |   \\ | /   |   \\ | /   |   \\ | /   |\n"
                print "1 #{stonesArr[9]} - - #{stonesArr[10]} - - #{stonesArr[11]} - - #{stonesArr[12]} - - #{stonesArr[13]} - - #{stonesArr[14]} - - #{stonesArr[15]} - - #{stonesArr[16]} - - #{stonesArr[17]}\n"
                print "  |   / | \\   |   / | \\   |   / | \\   |   / | \\   |\n"
                print "  | /   |   \\ | /   |   \\ | /   |   \\ | /   |   \\ |\n"
                print "2 #{stonesArr[18]} - - #{stonesArr[19]} - - #{stonesArr[20]} - - #{stonesArr[21]} - - #{stonesArr[22]} - - #{stonesArr[23]} - - #{stonesArr[24]} - - #{stonesArr[25]} - - #{stonesArr[26]}\n"
                print "  | \\   |   / | \\   |   / | \\   |   / | \\   |   / |\n"
                print "  |   \\ | /   |   \\ | /   |   \\ | /   |   \\ | /   |\n"
                print "3 #{stonesArr[27]} - - #{stonesArr[28]} - - #{stonesArr[29]} - - #{stonesArr[30]} - - #{stonesArr[31]} - - #{stonesArr[32]} - - #{stonesArr[33]} - - #{stonesArr[34]} - - #{stonesArr[35]}\n"
                print "  |   / | \\   |   / | \\   |   / | \\   |   / | \\   |\n"
                print "  | /   |   \\ | /   |   \\ | /   |   \\ | /   |   \\ |\n"
                print "4 #{stonesArr[36]} - - #{stonesArr[37]} - - #{stonesArr[38]} - - #{stonesArr[39]} - - #{stonesArr[40]} - - #{stonesArr[41]} - - #{stonesArr[42]} - - #{stonesArr[43]} - - #{stonesArr[44]}\n"
